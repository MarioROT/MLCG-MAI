...
# integrator = CMCIntegrator(40, DIRECTORY + FILENAME, EXPERIMENT, CosinePDF(1))
# myGPs = []
# for i in range(40):
...
myGPs = []
for i in range(40):
    myGP = GP(SobolevCov(),CosineLobe(1))
    (sample_set, sample_prob) = sample_set_hemisphere(40,CosinePDF(1))
    myGP.add_sample_pos(sample_set)
    myGPs.append(myGP)
integrator = BayesianMonteCarloIntegrator(40, myGPs, DIRECTORY + FILENAME, EXPERIMENT)
...
# scene = cornell_box_scene(0.75, 3, areaLS=False)
